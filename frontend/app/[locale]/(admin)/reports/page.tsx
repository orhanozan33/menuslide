  ...
  return (
    <div className="min-w-0 overflow-x-hidden">
      ...
      {(adminInvoiceModal.loading || adminInvoiceModal.data) && (
        <InvoiceModal
          data={adminInvoiceModal.data as import('@/components/InvoiceModal').InvoiceModalData | null}
          loading={adminInvoiceModal.loading}
          onClose={() => setAdminInvoiceModal({ userId: '', data: null, loading: false })}
        />
      )}
    </div>
  );
